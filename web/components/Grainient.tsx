...
// Ported from react-bits (npx shadcn add @react-bits/Grainient-JS-CSS),
// typed for this project's strict TypeScript setup. Slow animated WebGL
// gradient with grain, rendered via ogl (a tiny WebGL2 helper — no other
// deps). Replaces the earlier canvas-2D Waves background.
