...
// Ported from react-bits (npx shadcn add @react-bits/Waves-JS-CSS), typed
// for this project's strict TypeScript setup. Animated wave-grid background
// drawn on a <canvas>, perturbed by Perlin noise plus a mouse-follow ripple.
// No external deps (the Perlin noise implementation is self-contained).
...
export default function Waves({
  ...
  // Lazily created inside the setup effect below (not during render) so
  // Math.random() doesn't run as an impure side effect of rendering.
